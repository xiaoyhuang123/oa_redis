 ...
 */
public class TaskProtocalVo implements Serializable {
    private Long id;
    ...
    private List<TaskVo> fuzerenList ;

    private List<TaskVo> luoshirenList;
    ...
    public List<TaskVo> getFuzerenList() {
        return fuzerenList;
    }

    public void setFuzerenList(List<TaskVo> fuzerenList) {
        this.fuzerenList = fuzerenList;
    }

    public List<TaskVo> getLuoshirenList() {
        return luoshirenList;
    }

    public void setLuoshirenList(List<TaskVo> luoshirenList) {
        this.luoshirenList = luoshirenList;
    }

    @Override
    public String toString() {
        final StringBuffer sb = new StringBuffer("TaskProtocalVo{");
        ...
        sb.append(", fuzerenList=").append(fuzerenList);
        sb.append(", luoshirenList=").append(luoshirenList);
        sb.append('}');
        return sb.toString();
    }
}
