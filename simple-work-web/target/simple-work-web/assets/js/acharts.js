;(function() {
    ...
    achart_series_107_src_stacked_debug = function (exports) {
        /**
         * @fileOverview å¤„ç†å±‚å çš„æ•°æ®åºåˆ—çš„æ‰©å±•
         * @ignore
         */
        var Util = achart_util_110_index_debug;
        /**
         ...
         * @protected
         * æ­¤ç±»æ˜¯ä¸€ä¸ªæ‰©å±•ï¼Œä¸åº”è¯¥ç›´æŽ¥å®žä¾‹åŒ–,ä¸»è¦ç”¨äºŽåŒºåŸŸå›¾ï¼ŒæŸ±çŠ¶å›¾å±‚å çš„åœºæ™¯
         *
         *  - <a href="http://spmjs.io/docs/achart-series/latest/api/stacked.html" target="_blank">æ–‡æ¡£</a>
        ...
        Stacked.ATTRS = {
            /**
             * æ•°æ®åºåˆ—å±‚å çš„ç±»åž‹
             *   - none : ä¸è¿›è¡Œå±‚å
             *   - normal : ä¸€èˆ¬çš„å±‚å æ–¹å¼ï¼ŒåŽé¢çš„æ•°æ®åºåˆ—çš„yå€¼åœ¨å‰ä¸€ä¸ªæ•°æ®åºåˆ—åŸºç¡€ä¸Šæ˜¾ç¤º
             *   - percent : æŒ‰ç…§ç™¾åˆ†æ¯”è¿›è¡Œå±‚å å±•ç¤º
             * @type {String}
             */
            stackType: 'none'
        };
        Util.augment(Stacked, {
            ...
            /**
             * @protected
             * è½¬æ¢æ˜¾ç¤ºçš„å€¼ï¼Œä¸€èˆ¬ç”¨äºŽå±‚å çš„æ•°æ®åºåˆ—ä¸­
             */
            ...
            /**
             * èŽ·å–æç¤ºä¿¡æ¯
             * @return {*} è¿”å›žæ˜¾ç¤ºåœ¨ä¸Šé¢çš„æ–‡æœ¬
             */
    ...
    achart_theme_101_index_debug = function (exports) {
        /**
         * @fileOverview å›¾è¡¨çš„çš®è‚¤
         * @ignore
         */
        var Util = achart_util_110_index_debug;
        /**
         * Chart.Theme
         * @param {Object} cfg  æ ·å¼çš„é…ç½®é¡¹
         * @param {Object} base æ‰©å±•çš„æ ·å¼
         */
        ...
        // æ‰€æœ‰çš„åŸºç¡€æ ·å¼.ç”±äºŽæ·±åº¦ç»§æ‰¿,æ‰€ä»¥æ•°ç»„ç±»çš„è‡ªå·±è¦†ç›–
        ...
        // smoothé£Žæ ¼çš„åŸºç¡€æ ·å¼,è‰²ç³»åˆ†å¸ƒå‡ä¸º6ç§.
    ...
    achart_flags_101_src_flag_debug = function (exports) {
        ...
        Util.augment(Flag, {
            ...
            /**
             * ä¿®æ”¹flagé…ç½®ï¼Œä¼šè§¦å‘é‡ç»˜
             * @param {Object} item æ–°çš„é…ç½®ä¿¡æ¯
             */
            ...
            //ä¸ºäº†å †å ï¼Œæ ¹æ®é…ç½®èŽ·å–topYå’ŒbottomY
    ...
    achart_candlesticks_101_src_candlestick_debug = function (exports) {
        /**
         * @fileOverview è‚¡ç¥¨kçº¿å›¾ å•ä¸ªèŠ‚ç‚¹
         * @ignoreig
         */
        var Util = achart_util_110_index_debug, Item = achart_plot_111_index_debug.Item;
        /**
        ...
        Candlestick.ATTRS = {
            ...
            fallLine: null,
            /**
             * ä¸Šå‡çš„å›¾å½¢çš„é…ç½®ä¿¡æ¯
             * @type {Object}
             */
            riseShape: null,
            /**
             * ä¸‹é™çš„å›¾å½¢çš„é…ç½®ä¿¡æ¯
             * @type {Object}
             */
            fallShape: null,
            /**
    ...
    achart_series_other_104_src_bubble_debug = function (exports) {
        ...
        Bubble.ATTRS = {
            ...
            legendType: 'circle',
            /**
             * å¦‚æžœä¼ å…¥çš„æ•°æ®æ˜¯å¯¹è±¡é‚£ä¹ˆè¿™ä¸ªå­—æ®µæ ‡ç¤ºåŠå¾„ä»£è¡¨çš„å­—æ®µ
             * @type {String}
             */
            radiusField: 'r',
            animate: true,
        ...
        Util.augment(Bubble, {
            ...
            /**
             * @protected
             * èŽ·å–å¯ä»¥è¢«æ¿€æ´»çš„å…ƒç´
             * @return {Chart.Actived[]} å¯ä»¥è¢«æ¿€æ´»çš„å…ƒç´ é›†åˆ
             */
            getActiveItems: function () {
                return this.getItems();
            },
             ...
             * @protected
             * æ˜¯å¦æ¿€æ´»
             * @param {Chart.Actived} item å¯ä»¥è¢«æ¿€æ´»çš„å…ƒç´
             * @return {Chart.Actived[]} å¯ä»¥è¢«æ¿€æ´»çš„å…ƒç´ é›†åˆ
             */
            isItemActived: function (item) {
                return item.get('actived');
    ...
    achart_series_other_104_src_scatter_debug = function (exports) {
        /**
         * @fileOverview æ•£åˆ—å›¾,ç”¨äºŽæ ‡ç¤ºç‚¹çš„åˆ†æ­¥
         * @ignore
         */
            ...
            _getPoints: function () {
                ...
                Util.each(data, function (item, index) {
                    ...
                    if (Util.isObject(item)) {
                        ...
                        //ä¸å­˜åœ¨è½ç‚¹çº¿æ¡ åˆ™è½åˆ°åæ ‡è½´ä¸Šé¢
                        ...
                        if (!point)
                            return true;
                        //è‹¥å­˜åœ¨åæ ‡è½´ä¸€æ ·çš„flag  å¾€ä¸Šå †å
